    const SortingLibrary = {
        ...
        SortingLibrary.exchangeSort(myArray.slice(), 'asc');

      
        SortingLibrary.selectionSort(myArray.slice(), 'asc');

       
        SortingLibrary.insertionSort(myArray.slice(), 'asc');

        
        SortingLibrary.shellSort(myArray.slice(), 'asc');

        const comparisons = SortingLibrary.quickSort(myArray.slice(), 'asc');
        console.log(`Порівнянь у швидкому сортуванні: ${comparisons}`);
